...
static void output_status_handle_focused_tags(void *data        __attribute__((unused)),
		struct zriver_output_status_v1 *zriver_output_status_v1 __attribute__((unused)),
		uint32_t tags) {
	log_debug_c_s("status:"); log_debug_c("focused_tags:"); log_debug_c_e("0x%u", tags);
}

static void output_status_handle_view_tags(void *data           __attribute__((unused)),
		struct zriver_output_status_v1 *zriver_output_status_v1 __attribute__((unused)),
		struct wl_array *tags __attribute__((unused))) {
	log_debug_c_s("status:"); log_debug_c_e("view_tags");
}

static void output_status_handle_urgent_tags(void *data         __attribute__((unused)),
		struct zriver_output_status_v1 *zriver_output_status_v1 __attribute__((unused)),
		uint32_t tags) {
	log_debug_c_s("status:"); log_debug_c("urgent_tags:"); log_debug_c_e("0x%u", tags);
}

static void output_status_handle_layout_name(void *data         __attribute__((unused)),
		struct zriver_output_status_v1 *zriver_output_status_v1 __attribute__((unused)),
		const char *name) {
	log_debug_c_s("status:"); log_debug_c("layout_name:"); log_debug_c_e("%s", name);
}

static void output_status_handle_layout_name_clear(void *data   __attribute__((unused)),
		struct zriver_output_status_v1 *zriver_output_status_v1 __attribute__((unused))) {
