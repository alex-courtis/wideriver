...
static void output_status_handle_focused_tags(void *data,
	...
	log_d_c_s("output_focused_tags"); log_d_c("%d", output ? output->name : -1); log_d_c("tags"); log_d_c_e("0x%u", tags);
}
...
static void output_status_handle_view_tags(void *data,
	...
	log_d_c_s("output_view_tags"); log_d_c_e("%d", output ? output->name : -1);
}
...
static void output_status_handle_urgent_tags(void *data,
	...
	log_d_c_s("output_urgent_tags"); log_d_c("%d", output ? output->name : -1); log_d_c("tags"); log_d_c_e("0x%u", tags);
}
...
static void output_status_handle_layout_name(void *data,
	...
	log_d_c_s("output_layout_name"); log_d_c("%d", output ? output->name : -1); log_d_c("name"); log_d_c_e("%s", name);
}
...
static void output_status_handle_layout_name_clear(void *data,
	...
	log_d_c_s("output_layout_name_clear"); log_d_c_e("%d", output ? output->name : -1);
}
